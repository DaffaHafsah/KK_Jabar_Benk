...
var map = new ol.Map({
    ...
    layers: layersList,
    view: new ol.View({
        extent: [11669875.556153, -951034.891134, 12302630.495812, -600921.338915], maxZoom: 28, minZoom: 1
    })
});

//initial view - epsg:3857 coordinates if not "Match project CRS"
map.getView().fit([11669875.556153, -951034.891134, 12302630.495812, -600921.338915], map.getSize());
